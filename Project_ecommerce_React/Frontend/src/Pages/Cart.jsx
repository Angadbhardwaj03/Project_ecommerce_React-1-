...
const Cart = () => {
  ...
  const fetchCart = () => {
    axios.get('https://project-ecommerce-react-1-9ojl.onrender.com/cart')
      .then((response) => {
...
//   };
  ...
  const reduceQuantity = (productId) => {
    axios.delete(`https://project-ecommerce-react-1-9ojl.onrender.com/cart/reduce/${productId}`)
      .then(() => fetchCart())
      .catch((err) => console.error('Error reducing quantity:', err));
  };

  const deleteProduct = (productId) => {
    axios.delete(`https://project-ecommerce-react-1-9ojl.onrender.com/cart/delete/${productId}`)
      .then(() => fetchCart())
